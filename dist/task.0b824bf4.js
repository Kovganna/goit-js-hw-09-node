...
refs.closeLightboxOverlay.addEventListener('click', closeModalWindow); //создание карточки галлереи

var addGalleryEl = _app.galleryItems.map(function (el) {
  var addGalleryItem = "<li class=\"gallery__item\">\n  <a\n    class=\"gallery__link\"\n    href= ".concat(el.original, "\n  >\n    <img\n      class=\"gallery__image\"\n      src=\"").concat(el.preview, "\"\n      data-source=\"").concat(el.original, "\"\n      alt=\"").concat(el.description, "\"\n    />\n  </a>\n</li>");
...
function onImageClick(event) {
  if (event.target.nodeName === 'IMG') {
    ...
    refs.lightboxImage.dataset.index = event.target.dataset.index; // console.log(event.target.nodeName)
  } else {
    return;
  }
...
function closeModalWindow() {
  ...
  refs.lightboxImage.alt = "#"; // window.removeEventListener('keydown', keyEscape);
}
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/task.js"], null)
//# sourceMappingURL=/task.0b824bf4.js.map